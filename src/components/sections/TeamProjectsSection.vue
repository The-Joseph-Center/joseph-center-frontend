...
const { projects, loading, error } = useProjects('teamProject');
</script>
  ...
  <section class="py-16 px-6 bg-[var(--color-surface)]">
    <div class="max-w-6xl mx-auto">
      ...
      <div v-else-if="!projects.length" class="text-center py-12">
        <p class="text-[var(--color-text-secondary)] text-sm">No team projects to show yet.</p>
      </div>
